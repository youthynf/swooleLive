...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIKMlY7j73H0eK"; // AccessKeyId

        $accessKeySecret = "KmBpiZMRcDDFv1VgHIgU7cx4xBXCgE"; // AccessKeySecret
    ...
    public static function sendSms($phone, $code) {
        ...
        $request->setSignName("简易直播平台app");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_136381707");
